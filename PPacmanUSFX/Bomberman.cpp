...
Bomberman::Bomberman(Tile* _tile, Texture* _bombermanTexture, int _posicionX, int _posicionY, int _ancho, int _alto, int _anchoPantalla, int _altoPantalla, int _velocidadPatron) :
	GameObject(_bombermanTexture, _posicionX, _posicionY, _ancho, _alto, _anchoPantalla, _altoPantalla)
{
	tileActual = _tile;
...
void Bomberman::setTile(Tile* _tileNuevo) {
	if (tileActual != nullptr) {
...
bool Bomberman::tratarDeMover(MoveDirection _direccionNueva) {
